...
import folderExists from 'roc-utils/lib/folderExists';
...
export default function generateDocumentation({
    ...
    const projectName = commandObject.context.packageJSON.name;
    ...
    const documentation = [
        {
            content: createReadme(projectName, directory, extension, commandObject),
            path: extension ? `${dir}/README.md` : `${dir}/ROC.md`,
        }, {
            content: actionsToMarkdown(projectName, commandObject.context.actions, mode, project),
            path: `${documentationDir}/Actions.md`,
        }, {
            content: dependenciesToMarkdown(projectName, extension, commandObject.context.dependencies),
            path: `${documentationDir}/Dependencies.md`,
        }, {
            content: hooksToMarkdown(projectName, commandObject.context.hooks, mode),
            path: `${documentationDir}/Hooks.md`,
        }, {
            content: settingsToMarkdown(projectName, config, commandObject.context.meta),
