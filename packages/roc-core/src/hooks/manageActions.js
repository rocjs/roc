...
export function registerActions(actions, extensionName, state = getContext().actions, project = false) {
 ...
 */
export function registerAction(action, extensionName, state = getContext().actions, project = false) {
...
/* eslint-disable no-param-reassign */
export function removeActions(state = getContext().actions) {
