...
describe('roc', () => {
    describe('commands', () => {
        describe('init', () => {
            ...
            xit('should terminate if alias does not exists', () => {
                readdirSync.andReturn([]);
            ...
            xit('should directly fetch template if provided by full name without version given', () => {
                const dirPath = setupMocks({ versions: ['1.0'] });

                return consoleMockWrapper((log) => {
                    return init({
                        parsedArguments: { arguments: { template: 'rocjs/roc-template-web-app' } },
                        parsedOptions: { options: {} }
                    })
                    .then(() => {
            ...
            xit('should use directory as install dir', () => {
            ...
            xit('should choose name over directory', () => {
                const dirPath = setupMocks();
            ...
            xit('should handle invalid template', () => {
                readdirSync.andReturn([]);
            ...
            xit('should manage the provided template version as expected', () => {
